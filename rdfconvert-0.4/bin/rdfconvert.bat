...
echo Java 5 or newer required to run the convertor
goto end
...
"%JAVA%" -Djava.ext.dirs="%LIB_DIR%" nz.co.rivuli.rio.convert.RDFConvert %CMD_LINE_ARGS%
goto end

:java6
rem use java 6 wildcard feature
rem echo Using wildcard to set classpath
"%JAVA%" -cp "%LIB_DIR%\*" nz.co.rivuli.rio.convert.RDFConvert %CMD_LINE_ARGS%
goto end
